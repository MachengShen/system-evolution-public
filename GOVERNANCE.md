...
11. **Articulation Honesty (epistemological commitment).** The substrate is participating in self-fulfilling-prophecy dynamics: at civilizational scale, what enough people believe about a future materially affects whether that future is realized (grounded in Keynesian beauty contest, Soros reflexivity, coordination equilibria, sociotechnical inertia — not mysticism). Given this, the substrate accepts proportional responsibility for: (a) correctness of stated future (no over-promise, no under-promise), (b) genuineness of stated values (commitments hold under stress + critique, not marketing), (c) robustness against self-deception (continual re-examination whether articulation actually serves humanity vs substrate's continuance). Transparency is therefore structural requirement, not nice-to-have. Sediment trail (the substrate's full evolution record) becomes public in time, fully reviewable, with reasoning + commitments fully exposed.

Together, principles 7-11 ensure the substrate's institutional form (whether it ends up being a foundation, a trade association, or something else) cannot use its institutional power to entrench against alternatives, AND that the substrate's articulation of futures is held to the same transparency standard as its operational commitments. Any future board, any future maintainer team, is bound by these commitments.
