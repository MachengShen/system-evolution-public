...
> Format: [Claim-Receipt](../CLAIM-RECEIPT.md) · Cognition Track node: [General Learning Machine as Dynamical System](https://github.com/MachengShen/cognition-track/blob/master/nodes/mem_ccacc817ccd8.md) `mem_ccacc817ccd8` (per-sub-claim breakdown there). A speculative tag means this is an idea, not an established result.
