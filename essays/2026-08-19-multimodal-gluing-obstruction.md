...
> - **Corollary "contrastive co-training is a gluing-repair loop that suppresses the obstruction":** 🔴→🟡 **revised by E4 (2026-08-19/22)** — co-training does not press the obstruction toward zero, it *discards* the obstructed structure: in the synthetic rig the measured residual falls to 23–33 % of the analytic floor only where the floor > 0, by dropping 34–59 % of the constraint-field norm (control: 0 %), while the readout-bounded violation never goes below the floor (150/150 cells); on real frozen DINOv2×mpnet towers a linear repair head beats CLIP on alignment (0.063 vs 0.050, same split) yet leaves the noise-corrected residual unchanged (0.036→0.040) — CLIP's 4.7× lower residual comes from re-carving, not the alignment loss. **"Repair" → "collapse"**, confidence 0.8 mechanism / 0.6 generality. Per-concept non-alignability order predicted from projection geometry survives training (Spearman 0.73; shared types 0.55) but ceiling-compressed. [RESULTS-E4](2026-08-19-multimodal-gluing-obstruction/RESULTS-E4.md)
>
...
Attachments: [README](2026-08-19-multimodal-gluing-obstruction/README.md) · [RESULTS-E1](2026-08-19-multimodal-gluing-obstruction/RESULTS-E1.md) · [RESULTS-E2](2026-08-19-multimodal-gluing-obstruction/RESULTS-E2.md) · [RESULTS-E4](2026-08-19-multimodal-gluing-obstruction/RESULTS-E4.md) (co-training as collapse, not repair) · `results/*.json`. Code (`e1_synthetic/`, `e2_real/`) available on request.
